...
const translations: Record<Language, Record<string, string>> = {
  ca: {
    ...
    // Public Form
    form_title: "Inscripció Oficial de Parelles - El Tast 2027",
    ...
    t_shirt_size: "Talla d'Armilla",
    armilla: "Armilla",
    desitges_armilla: "Vols armilla?",
    ...
    mocadors_desc: "Mocadors corporatius fúcsia extras amb escut brodat de l'edició 2027.",
  ...
  es: {
    ...
    // Public Form
    form_title: "Inscripción Oficial de Parejas - El Tast 2027",
    ...
    t_shirt_size: "Talla de Chaleco",
    armilla: "Chaleco",
    desitges_armilla: "¿Deseas chaleco?",
    ...
    mocadors_desc: "Pañuelos corporativos fucsia extras con escudo bordado de la edición 2027.",
